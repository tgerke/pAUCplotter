...
pAUCplotter <- function(response, predictor, partial.auc = c(1, .8), partial.auc.focus = "specificity",
   ...
   pAucCI <- ci.auc(rocFit, partial.auc = partial.auc, partial.auc.focus = partial.auc.focus, 
   ...
   return(list(aucEst = aucEst, aucCI = aucCI, pAucEst = pAucEst, pAucCI = pAucCI))
}
